...
import { ViewProps, setViewProps, RNView } from '@nodegui/react-nodegui/dist/components/View/RNView';
 ...
 * @ignore
 */
export class RNBezier extends RNView { // QFrame implements RNWidget {
